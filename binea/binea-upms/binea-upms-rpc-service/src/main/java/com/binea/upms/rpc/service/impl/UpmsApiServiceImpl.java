...
import com.binea.upms.dao.mapper.*;
import com.binea.upms.dao.model.*;
import com.binea.upms.rpc.api.UpmsApiService;
import com.binea.upms.rpc.mappper.UpmsApiMapper;
...
public class UpmsApiServiceImpl implements UpmsApiService {
     ...
     */
    @Override
    @Cacheable(value = "binea-upms-rpc-service-ehcache", key = "'selectUpmsPermissionByUpmsUserId_' + #upmsUserId")
     ...
     */
    @Override
    @Cacheable(value = "binea-upms-rpc-service-ehcache", key = "'selectUpmsRoleByUpmsUserId_' + #upmsUserId")
