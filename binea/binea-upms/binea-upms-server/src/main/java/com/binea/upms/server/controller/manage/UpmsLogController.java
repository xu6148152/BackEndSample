...
import com.binea.common.util.StringUtil;
...
import com.binea.upms.rpc.api.UpmsLogService;
...
public class UpmsLogController extends BaseController {
    ...
    public Object delete(@PathVariable("ids") String ids) {
        ...
        return new UpmsResult(com.binea.upms.common.constant.UpmsResultConstant.SUCCESS, count);
    }
