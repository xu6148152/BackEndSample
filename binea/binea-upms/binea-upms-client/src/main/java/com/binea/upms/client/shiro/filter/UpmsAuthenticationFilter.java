package com.binea.upms.client.shiro.filter;

import com.alibaba.fastjson.JSONObject;
import com.binea.common.util.PropertiesFileUtil;
import com.binea.common.util.RedisUtil;
import com.binea.upms.client.shiro.session.UpmsSessionDao;
import com.binea.upms.client.util.RequestParameterUtil;
import com.binea.upms.common.constant.UpmsConstant;
...
public class UpmsAuthenticationFilter extends AuthenticationFilter {
    ...
    // 局部会话key
    private final static String ZHENG_UPMS_CLIENT_SESSION_ID = "binea-upms-client-session-id";
    // 单点同一个code所有局部会话key
    private final static String ZHENG_UPMS_CLIENT_SESSION_IDS = "binea-upms-client-session-ids";
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) {
        ...
        // 判断请求类型
        String upmsType = PropertiesFileUtil.getInstance("binea-upms-client").get("binea.upms.type");
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        StringBuffer ssoServerUrl = new StringBuffer(PropertiesFileUtil.getInstance("binea-upms-client").get("binea.upms.sso.server.url"));
        // server需要登录
        String upmsType = PropertiesFileUtil.getInstance("binea-upms-client").get("binea.upms.type");
        if ("server".equals(upmsType)) {
        ...
        ssoServerUrl.append("/sso/index").append("?").append("appid").append("=").append(PropertiesFileUtil.getInstance("binea-upms-client").get("binea.upms.appID"));
        // 回跳地址
