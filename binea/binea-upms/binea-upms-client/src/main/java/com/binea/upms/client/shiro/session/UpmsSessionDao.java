package com.binea.upms.client.shiro.session;

import com.binea.common.util.RedisUtil;
import com.binea.upms.client.util.SerializableUtil;
...
public class UpmsSessionDao extends CachingSessionDAO {
    ...
    // 会话key
    private final static String ZHENG_UPMS_SHIRO_SESSION_ID = "binea-upms-shiro-session-id";
    // 全局会话key
